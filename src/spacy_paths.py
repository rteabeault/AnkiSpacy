...
header_md_file = os.path.join(resources_dir, 'SpacyHeader.md')
checkmark_file = os.path.join(resources_dir, 'checkmark.png')
refresh_file = os.path.join(resources_dir, 'refresh.png')
incompatible_file = os.path.join(resources_dir, 'incompatible.png')
